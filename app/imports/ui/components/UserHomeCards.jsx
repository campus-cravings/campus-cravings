  ...
  render() {
    ...
    return (
        <div className="landing-cards">
          <Container>
            <Card.Group centered>
              <Card as={NavLink} exact to="/menu" key='menu' href='#'>
              ...
              <Card as={NavLink} exact to="/todaystoppicks" key='todaystoppicks' href='#'>
              ...
              <Card as={NavLink} exact to="/vendor" key='vendor' href='#'>
